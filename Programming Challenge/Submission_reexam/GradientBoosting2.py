...
# Best parameters: {'learning_rate': 0.06, 'max_depth': 4, 'min_samples_leaf': 3, 'min_samples_split': 2, 'n_estimators': 50, 'subsample': 1}
# 0.8825, 0.7201 Best parameters: {'learning_rate': 0.05, 'max_depth': 4, 'min_samples_leaf': 1, 'min_samples_split': 3, 'n_estimators': 50, 'subsample': 0.8}
# 0.8811, 0.7201 Best parameters: {'learning_rate': 0.05, 'max_depth': 4, 'min_samples_leaf': 1, 'min_samples_split': 3, 'n_estimators': 49, 'subsample': 0.8}
# 0.8811, 0.7201 Best parameters: {'learning_rate': 0.05, 'max_depth': 4, 'min_samples_leaf': 1, 'min_samples_split': 3, 'n_estimators': 49, 'subsample': 0.8}

# Best parameters: {'learning_rate': 0.03, 'max_depth': 3, 'min_samples_leaf': 1, 'min_samples_split': 2, 'n_estimators': 40, 'subsample': 1}
# Accuracy of Gradient Boosting Machines (optimized) on training data: 0.7783
# Accuracy of Gradient Boosting Machines (optimized) on test data: 0.7782

# Best parameters: {'learning_rate': 0.03, 'max_depth': 3, 'min_samples_leaf': 1, 'min_samples_split': 2, 'n_estimators': 40, 'subsample': 1}
# Accuracy of Gradient Boosting Machines (optimized) on training data: 0.7783
# Accuracy of Gradient Boosting Machines (optimized) on test data: 0.7782

# Best parameters: {'learning_rate': 0.05, 'max_depth': 3, 'min_samples_leaf': 1, 'min_samples_split': 3, 'n_estimators': 50, 'subsample': 0.9}
# Accuracy of Gradient Boosting Machines (optimized) on training data: 0.8370
# Accuracy of Gradient Boosting Machines (optimized) on test data: 0.7338
